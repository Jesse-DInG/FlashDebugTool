package yzhkof.ui
{
		...
		public class StateView extends Sprite
		{
			...
			private static var _INSTANCE : StateView;
			 ...
			 * respectively.
			 */
			public function StateView(minimized : Boolean = false, transparent : Boolean = false, meanDataLength : uint = 0, enableClickToReset : Boolean = true, enableModifyFrameRate : Boolean = true)
			{
				super();
			 ...
			 */
			public static function get instance() : StateView
			{
				if(!_INSTANCE)
				{
					_INSTANCE = new StateView();
				}
				return _INSTANCE;
			}
