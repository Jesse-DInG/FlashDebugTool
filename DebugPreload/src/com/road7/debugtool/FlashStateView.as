package com.road7.debugtool 
{
	 ...
	 */
	public class FlashStateView extends Sprite
	{
		...
		private static var _INSTANCE : FlashStateView;
		 ...
		 * respectively.
		 */
		public function FlashStateView(minimized : Boolean = false, transparent : Boolean = false, meanDataLength : uint = 0, enableClickToReset : Boolean = true, enableModifyFrameRate : Boolean = true)
		{
			super();
...
//			_INSTANCE = this;
		 ...
		 */
		public static function get instance() : FlashStateView
		{
			if(!_INSTANCE)
			{
				_INSTANCE = new FlashStateView();
			}
			return _INSTANCE;
		}
